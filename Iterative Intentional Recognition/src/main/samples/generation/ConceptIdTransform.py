"""
   脚本描述：建立本体概念取值的ID编码，提供本体概念与数值转换的接口, 提高检索效率
"""
...
if os.path.exists(concept_id_dict_path):
...
# information_content = {"concept1": 0.1, "concept2": 0.3...}
...
# ontology = {"concept1": ["concept2", "concept3", ...], ...}
...
# concepts_list = ["concept1", "concept2", "concept3", ...]
...
def intention_concept_to_id(intention, ontology_root):
    ...
    for tmp_sub_intention in intention:
        ...
        for tmp_dim in tmp_sub_intention.keys():
            ...
            # change None which means no intention to ontology root concept
