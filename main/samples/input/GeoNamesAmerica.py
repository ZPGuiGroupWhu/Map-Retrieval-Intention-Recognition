...
from main.util.FileUtil import load_json
from main.samples.generation.ConceptIdTransform import Ontology_concept_to_id, \
    concept_to_id, Information_Content_concept_to_id
import os.path

file_path_prefix = os.getcwd().split("main")[0] + "resources/ontologies/geonames_america"
