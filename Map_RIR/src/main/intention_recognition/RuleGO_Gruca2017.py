...
from Map_RIR.src.main.intention_recognition import Config, MDL_RM
from Map_RIR.src.main.samples.input import OntologyUtil
...
def RuleGo(terms, positive_samples, negative_samples, terms_covered_samples,
    ...
    # 获取候选规则
    rule_induction(terms, positive_samples, negative_samples, terms_covered_samples,
                                  max_depths, direct_ancestors, ancestors, ontologies, ontology_root)
