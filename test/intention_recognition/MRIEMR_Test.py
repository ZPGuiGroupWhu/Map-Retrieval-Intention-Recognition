...
def test_get_encoding_length_by_ppc():
...
def test_get_intention_by_method1():
    scene = "11"
...
def test_get_intention_by_method6():
...
def test_init_for_intention_extraction():
    scene = "362"
    sample_version = "scenes_v4_5"
    test_sample_path = "./../../resources/samples/" + sample_version + "/Scene" + scene + "/noise_samples_L1.json"
    Sample.load_sample(test_sample_path)
...
if __name__ == "__main__":
    time0 = time.time()
    # test_get_intention_by_method1()
    test_get_intention_by_method6()
    # test_init_for_intention_extraction()
